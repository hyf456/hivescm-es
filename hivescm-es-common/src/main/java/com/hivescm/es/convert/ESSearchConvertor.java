package com.hivescm.es.convert;
...
public final class ESSearchConvertor {
	...
	public static Map<Object, Object> object2Map(Object obj) throws IOException {
		return illegal(obj) ? null : objectMapper.readValue(objectMapper.writeValueAsString(obj), Map.class);
	}
	...
	public static Map<Object, Object> object2MapExcludeNullValue(Object obj) throws IOException {
		...
		final Map<Object, Object> map = objectMapper.readValue(objectMapper.writeValueAsString(obj), Map.class);
		removeNuLLValue(map);
		return map;
	}
