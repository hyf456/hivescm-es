...
import com.hivescm.es.search.escenter.validator.CollapseQueryValidator;
import com.hivescm.es.search.escenter.service.ESStatisticServiceImpl;
import com.hivescm.es.search.escenter.validator.StatisticByConditionsValidator;
...
public class ESStatisticController {
	...
	@RequestMapping(value = "/statisticByConditionsOMS", method = RequestMethod.POST)
	public DataResult<Map<String, Number>> statisticByConditionsOMS(@RequestBody StatisticESObject esObject) {
	...
	@RequestMapping(value = "/collapseOMS", method = RequestMethod.POST)
	public DataResult<Map<String, ESResponse>> collapseOMS(@RequestBody CollapseQueryObject esObject) {
