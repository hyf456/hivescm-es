package com.hivescm.es.search.escenter.groovy;
...
/**
 * Created by DongChunfu on 2017/8/18
 * <p>
 * 嵌套更新 groovy 脚本构建器
 */
@Component(value = "nestedUpdateGroovyScritpBuilder")
public class NestedUpdateGroovyScritpBuilder {
	...
	private static Script addTag(NestedESObject nestedESObject, Map<Object, Object> dataMap) {
		...
		params.put("listValue", listValue);//若为空，直接添加会导致后期添加不进去
