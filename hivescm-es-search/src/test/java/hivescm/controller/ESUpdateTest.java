...
public class ESUpdateTest {
	...
	public void updateTest() throws Exception {
		...
		final DataResult<Boolean> dataResult = esSearchController.esUpdateOMS(updateESObject);
	...
	public void batchUpdateTest() throws Exception {
		...
		final DataResult<Boolean> dataResult = esSearchController.esBatchUpdateOMS(batchUpdateESObject);
	...
	public void conditionUpdateTest() throws Exception {
		...
		final DataResult<Boolean> dataResult = esSearchController.conditionUpdateOMS(conditionUpdateESObject);
