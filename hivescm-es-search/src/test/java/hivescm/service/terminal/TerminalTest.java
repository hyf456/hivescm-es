package hivescm.service.terminal;
...
public class TerminalTest {
	...
	public void testTerminal() throws Exception {
		...
		sb.append("CURL -XPOST '192.168.177.134:9200/test_ool/ool/1/_update' -d '" + GSON.toJson(param) + "'");

		sb.append("CURL -XGET '192.168.177.134:9200/test_ool/ool/1'");
